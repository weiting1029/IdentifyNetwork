function [obj_GCV,obj_p11] = func_GCV_LASSO_S2(p11_can,N,T,X,Y,estimate_slack_var)
    obj_GCV = 100000;
    obj_p11 = p11_can(1);
    for i = 1:length(p11_can)
        p11 = p11_can(i);
...
%         x_initial(end-2:end)= 0;
        ...
        f_min_gmm_slack_stage2 = @(x)func_gmm_lasso_stage_two_slack(x,Y,X,p11,estimate_slack_var);
        [x_gmm_slack, obj_gmm_slack] = func_min_pen_obj_slack(f_min_gmm_slack_stage2,x_initial_slack,N);
